  ...
  const server = app.listen(TEST_PORT, async () => {
    ...
    try {
      ...
      const period = await ProjectPeriod.create({
        ...
        preDefenseSubmissionDeadline: new Date('2026-09-01'),
        defenseStart: new Date('2026-09-05'),
        defenseEnd: new Date('2026-09-10'),
        postDefenseRevisionDeadline: new Date('2026-09-20'),
