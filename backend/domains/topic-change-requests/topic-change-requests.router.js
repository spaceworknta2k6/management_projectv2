...
router.post('/:id/faculty-approve', requireRole(['FACULTY_STAFF', 'SYSTEM_ADMIN']), validator.validateIdParam, validator.validateReview, controller.facultyApprove);
router.post('/:id/faculty-reject', requireRole(['FACULTY_STAFF', 'SYSTEM_ADMIN']), validator.validateIdParam, validator.validateReview, controller.facultyReject);
